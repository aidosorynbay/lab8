...
let sum4_5 = lab4_5[0] + lab4_5[1] + lab4_5[2] + lab4_5[3] + lab4_5[4] +
 lab4_5[5] + lab4_5[6] + lab4_5[7] + lab4_5[8] + lab4_5[9] + lab4_5[10];
let sum6 = lab6[0] + lab6[1] + lab6[2] + lab6[3] + lab6[4] + lab6[5];

let sums = [sum1, sum2, sum3, sum4_5, sum6];

let total_score = ((sum1 + sum2 + sum3 + sum4_5 + sum6)/6 * 24/40) + (quiz1 * 16/40);
...
const results = 
{
    ...
    lab4_5: [5, 5, 5, 5, 5, 5, 8, 10, 10, 10, 3], // array of scores for lab4 and 5
    lab6: [0, 0, 0, 0, 0, 0], // array of scores for lab6
    quiz1: [34] , // score of quiz1
    sums: [sum1, sum2, sum3, sum4_5, sum6], // array of sums of each lab
    total_score: ((sum1 + sum2 + sum3 + sum4_5 + sum6)/6 * 24/40) + (quiz1 * 16/40), // computed total score
}
